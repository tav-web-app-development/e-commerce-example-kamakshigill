      ...
      <div className="container mx-auto px-4">
        <div className="sm:flex sm:justify-between">
          <div className="mb-4 sm:mb-0 max-w-lg">
            <h6 className="font-bold">About shoppers</h6>
            <p>
              shoppers is a leading online store offering a wide range of
        ...
        <div className="mt-8 text-center">
          <p>© {new Date().getFullYear()} Shoppers. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
